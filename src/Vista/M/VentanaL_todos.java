...
public class VentanaL_todos extends javax.swing.JFrame {
    private Biblioteca biblioteca;
    private String categoriaActual = "Todos";

    public VentanaL_todos(List<Libro> libros) {
        initComponents(); 
        cargarTabla(libros);
        setSize(731, 500); 
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Categoría Actualidad");
    ...
    if (categoriaActual.equalsIgnoreCase("Todos")) {
        libros = biblioteca.getTodosLosLibros(); // Mostrará todo
    } else {
        libros = biblioteca.getLibrosPorCategoria(categoriaActual);
    }
    ;
